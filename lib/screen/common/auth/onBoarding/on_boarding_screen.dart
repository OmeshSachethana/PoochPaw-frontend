...
import 'package:poochpaw/screen/common/auth/onBoarding/on_boarding_cubit.dart';
          ...
          builder: (context, state) {
            return Stack(
              children: [
                ...
                // Show "Continue" button on the last onboarding page
                Visibility(
...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        // Display image or icon based on the type
